...
"""
    open_stream(swipl, file::String, mode::Symbol = :write, create_file::Bool = false, alias::Union{String, Nothing} = nothing)::Union{PrologStream, Nothing}
...
- `alias::Union{String, Nothing}=nothing`: unique string for SWI-Prolog to identify the stream, automatically generated by default
"""
function open_stream(
    ...
    return PrologStream(stream_alias, mode, file, swipl)
end
